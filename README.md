...
| Pobieranie bardzo wolne (~80 KB/s) | Zainstaluj Node.js: `brew install node` (macOS) / [nodejs.org](https://nodejs.org/) (Windows) — yt-dlp potrzebuje go do rozwiązania YouTube n-challenge |
